...
ax3.plot(Qlist2, noise2, 'g', label = 'good data 2')
ax3.plot(Qlist3, noise3, 'r', label = 'good data 3')
ax3.plot(Qlist4, noise4, 'c', label = 'noisy data')
ax3.plot(Qlist4, noise_sum, 'm', label = '10x exposure time')
ax3.plot(Qlist1, noise1, 'b', label = 'good data')
plt.xlabel('Q')
plt.xlim(1.7, 3.7)
plt.ylim(-400, 400)
plt.ylabel('Noise')
