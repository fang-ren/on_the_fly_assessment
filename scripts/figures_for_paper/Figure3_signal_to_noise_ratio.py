...
path = '..\\..\\data\\'
file1 = path + 'Figure3_amorphous.csv'
file2 = path + 'Figure3_good_2.csv'
file3 = path + 'Figure3_good_3.csv'
file4 = path + 'Figure3_noisy_data_set.csv'
save_path = '..\\..\\figures\\'
...
ax1.plot(Qlist1, IntAve1+1500, 'b', label = 'Spectrum 1')
ax1.plot(Qlist2, IntAve2+900, 'g', label = 'Spectrum 2')
ax1.plot(Qlist3, IntAve3+500, 'r', label = 'Spectrum 3')
ax1.plot(Qlist4, IntAve4, 'c', label = 'Spectrum 4')
ax1.plot(Qlist4, IntAve_sum-500, 'm', label = 'Spectrum 5')
plt.ylabel('Intensity')
plt.xlim(1.7, 3.7)
plt.ylim(200, 3100)
ax1.annotate('(a)', xy=(1.75,2700))
...
ax3.plot(Qlist2, noise2, 'g')
ax3.plot(Qlist3, noise3, 'r')
ax3.plot(Qlist4, noise4, 'c')
ax3.plot(Qlist4, noise_sum, 'm')
ax3.plot(Qlist1, noise1, 'b')
plt.xlabel('Q')
plt.xlim(1.7, 3.7)
plt.ylim(-400, 400)
plt.ylabel('Noise')
...
ax5.bar(bins1[:-1], n1, color = 'blue', edgecolor = 'none', label = 'Spectrum 1')
plt.yscale('log')
plt.xlim(-50, 50)
plt.ylim(0, 200)
...
ax6.bar(bins2[:-1], n2, color = 'g', edgecolor = 'none', label = 'Spectrum 2')
plt.yscale('log')
plt.xlim(-50, 50)
plt.ylim(0, 200)
...
ax7.bar(bins3[:-1], n3, color = 'red', edgecolor = 'none', label = 'Spectrum 3')
plt.xlim(-50, 50)
# plt.ylim(0, 10)
...
ax8.bar(bins4[:-1], n4, color = 'cyan', edgecolor = 'none', label = 'Spectrum 4')
plt.xlim(-110, 110)
# plt.ylim(0, 10)
...
# n1[200] = (n1[199]+n1[201])/2
ax4.bar(bins_sum[:-1], n_sum, color = 'm', edgecolor = 'none', label = 'Spectrum 5')
plt.xlim(-110, 110)
...
ax9.annotate('calculated directly from noise spectrum', xy=(np.log(1/popt2[2]), SNR2+1), xytext=(np.log(1/popt2[2])-3, SNR2+10),
             arrowprops=dict(facecolor='black', shrink=0.05))
# ax9.plot([1]*len(np.arange(ax9.get_ylim()[0], ax9.get_ylim()[1])), np.arange(ax9.get_ylim()[0], ax9.get_ylim()[1]), 'k')
ax9.add_patch(patches.Rectangle((-3.15, 31.65), 7.15, 38.35,alpha = 0.5, facecolor= 'yellow'))
...
ax9.plot(x[0], y[0], 'o', color = 'b', label = '1')
ax9.plot(x[1], y[1], 'o', color = 'g', label = '2')
ax9.plot(x[2], y[2], 'o', color = 'r', label = '3')
ax9.plot(x[3], y[3], 'o', color = 'c', label = '4')
ax9.plot(x[4], y[4], 'o', color = 'm', label = '5')
...
plt.savefig(save_path+'Figure3', dpi = 600)
# plt.close('all')
#
# plt.figure(2)
