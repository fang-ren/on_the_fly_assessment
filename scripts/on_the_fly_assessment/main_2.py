...
PP = 0.968   # beam polarization, according to beamline setup. Contact beamline scientist for this number
pixelSize = 79  # detector pixel size, measured in microns

# folder and file info
calibration_file = 'C:\\Users\\fangren\\Downloads\\b_myuan_Pd_RT_He_2_scan0_0002.calib' # specify the file path for the WxDiff calibration file
folder_path = 'C:\\Users\\fangren\\Downloads'  # specify a folder for the software to watch
base_filename = '01_RT_to_280_0barg_He_scan1_'   # in order for the program to recognize newly created files, the file needs to
...
index = 0   # starting from this scan# The program will automatically add digits to make it into four ditigs, for example, 1 will become 0001, 100 will become 0100
