...
folder_path = 'C:\Research_FangRen\Data\Metallic_glasses_data\CoZrFe_ternary\Sample1'  # specify a folder for the software to watch
base_filename = 'Sample1_24x24_t30_'   # in order for the program to recognize newly created files, the file needs to
...
last_scan = 441  # end with this scan#, if not sure, fill in a large number like 1000
...
extract_neighbor_distance_module = 'off'
